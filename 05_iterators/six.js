...
// console.log(values); // forEach koi si bhi value return nhi karta hai : undefined hee print hoga
...
const books = [
  ...
  //mujhe wo sabhi books chahiye jinka genre History hai
  let userBooks = books.filter( (bk) => bk.genre === 'History')
 //userBooks jo bana h upr wo neeche waale se independent h 
